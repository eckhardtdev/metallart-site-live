      ...
      <div className={clsx('relative w-full')}>
        <div className="relative">
          <textarea
            className={clsx(
              ...
              !invalid
                ...
                : 'pr-[clac(100%_-_2.5rem)] text-error-text placeholder:text-error-placeholder',
            )}
            id={id}
          ...
          <label
            ...
            className={clsx(
              'pb-1.5 pt-4',
              'pointer-events-none absolute left-0 top-0 flex h-full w-full select-none !overflow-visible truncate text-16 font-normal leading-tight transition-all md:text-24',
              'origin-top-left',
              'peer-focus:-translate-y-3 peer-focus:scale-50 peer-focus:opacity-50',
              'peer-focus:leading-tight peer-focus:text-creme ',
